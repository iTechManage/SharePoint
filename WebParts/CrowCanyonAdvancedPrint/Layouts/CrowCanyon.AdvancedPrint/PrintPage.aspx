...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintPage.aspx.cs" Inherits="CrowCanyonAdvancedPrint.Layouts.CrowCanyon.AdvancedPrint.PrintPage"
                ...
                <table cellspacing="0" class="ms-menutoolbar" cellpadding="2" width="100%">
                    <tr>
                        <td>
                            ...
                            <asp:DropDownList  class="ms-toolbar" ID="TemplatesList" runat="server" AutoPostBack="True" Width="20%">
                            </asp:DropDownList>
                     
                        <asp:Label class="ms-toolbar" ID="lbl2" runat="server" Text="View:"></asp:Label>
                        <asp:DropDownList  class="ms-toolbar" ID="DropDownList1" runat="server" AutoPostBack="True" Width="20%">
