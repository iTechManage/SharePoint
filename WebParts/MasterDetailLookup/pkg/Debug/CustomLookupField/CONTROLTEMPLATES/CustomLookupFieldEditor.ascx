...
<asp:DropDownList ID="customList" runat="server" AppendDataBoundItems="true" Visible="false">
    ...
    <table runat= "server" ID = "MultiColumnTable" style="width: 570px; border-width: 0px; border-collapse: collapse;" cellpadding="0" cellspacing="0" visible="false">
        <tr>
    ...
    <br />
<asp:LinkButton runat="server" ID="lbAddNew" Text="New Entry" Visible="false"/> 
