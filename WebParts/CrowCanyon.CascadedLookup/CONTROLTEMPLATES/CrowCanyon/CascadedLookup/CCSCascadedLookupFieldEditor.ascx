...
<ContentTemplate> <style type="text/css">
                    .style1
                    {
                        width: 100%;
                        height: 48px;
                        ...
                        <table>
                            <tr>
                                <td class="ms-authoringcontrols" nowrap="nowrap">
                                    <asp:Label ID="lblConvertFromRegular" runat="server" Text="Convert from:" />
                                </td>
                                <td class="ms-authoringcontrols">
                                    <asp:DropDownList ID="ddlConvertFromRegular" runat="server" />
                                </td>
                                <td class="ms-authoringcontrols">
                                    <asp:Button ID="btnConvertFromRegular" runat="server" Text="Convert" CssClass="ms-ButtonHeightWidth"
                                        ValidationGroup="cfconvert" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
...
<ContentTemplate><div style="width: 100%; text-align: left; border-width: 0px;">
                    <table style="width: 100%; border-width: 0px; border-collapse: collapse;" cellpadding="0"
                        cellspacing="0">
                        <tr>
                            <td class="ms-authoringcontrols" style="width: 100%; text-align: left; white-space: nowrap;">
